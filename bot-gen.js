...
const mapLALALAData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLALALAPath, 'utf8');

const mapSurvivalPath = path.join(__dirname, 'Mapas', 'Survival Room _ Leo.hbs');
const mapSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSurvivalPath, 'utf8');

const mapMeteorsPath = path.join(__dirname, 'Mapas', 'Meteors Survival v3 from HaxMaps.hbs');
const mapMeteorsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapMeteorsPath, 'utf8');

const mapJumpingPath = path.join(__dirname, 'Mapas', 'Jumping Arena by MC [20 players].hbs');
const mapJumpingData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapJumpingPath, 'utf8');

const mapWebSurvivalPath = path.join(__dirname, 'Mapas', 'Web Survival Version 2 by Namajunas [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapWebSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapWebSurvivalPath, 'utf8');

const mapGalacticPath = path.join(__dirname, 'Mapas', 'Galactic Fit by Vhagar & Jordan [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapGalacticData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGalacticPath, 'utf8');

const mapSupermanPath = path.join(__dirname, 'Mapas', 'Superman Chair v2 by Namajunas [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapSupermanData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSupermanPath, 'utf8');

const mapSurvivalSquarePath = path.join(__dirname, 'Mapas', 'Survival Square Deluxe by _R [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapSurvivalSquareData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSurvivalSquarePath, 'utf8');

const mapGymPath = path.join(__dirname, 'Mapas', 'GYM from HaxMaps.hbs');
const mapGymData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGymPath, 'utf8');

const mapMultiBallsPath = path.join(__dirname, 'Mapas', 'MultiBalls Survival by Galactic Boy from HaxMaps.hbs');
const mapMultiBallsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapMultiBallsPath, 'utf8');

const mapUltraBallPath = path.join(__dirname, 'Mapas', 'ULTRABALL.hbs');
const mapUltraBallData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapUltraBallPath, 'utf8');

const mapDodgeballPath = path.join(__dirname, 'Mapas', 'Dodgeball by MC.hbs');
const mapDodgeballData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapDodgeballPath, 'utf8');
const mapDodgeballV2Path = path.join(__dirname, 'Mapas', 'Dodgeball v2 _ Leo.hbs');
const mapDodgeballV2Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapDodgeballV2Path, 'utf8');
const mapNumberChairsPath = path.join(__dirname, 'Numberchair', 'NumberChairs v2 by Şerefli Şeref [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapNumberChairsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapNumberChairsPath, 'utf8');
...
for (let v = 3; v <= 21; v++) {
    ...
    if (files.length > 0) {
        numberChairMaps[v] = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(path.join(numberChairDir, files[0]), 'utf8');
    }
}

const mapChairMixPath = path.join(__dirname, 'Mapas', 'ChairMix by Vhagar.hbs');
const mapChairMixData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapChairMixPath, 'utf8');

const mapCollisionPath = path.join(__dirname, 'Mapas', 'Collision team racing 9 by MC  from HaxMaps.hbs');
const mapCollisionData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCollisionPath, 'utf8');

// Map: Space Melee
const mapSpaceMeleePath = path.join(__dirname, 'Mapas', 'Space Melee by Namajunas [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapSpaceMeleeData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpaceMeleePath, 'utf8');

// Map: Spot Bonk
const mapSpotBonkPath = path.join(__dirname, 'Mapas', 'Spot Bonk by MC from HaxMaps.hbs');
const mapSpotBonkData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpotBonkPath, 'utf8');

// Map: COVID-19 Survival (Teams)
const mapCovid19Path = path.join(__dirname, 'Mapas', 'Covid-19 Survival [Teams] by Galactic Boy.hbs');
const mapCovid19Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCovid19Path, 'utf8');

// Map: Gymmix 6
const mapGymmixPath = path.join(__dirname, 'Mapas', 'Gymmix 6 by MC.hbs');
const mapGymmixData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGymmixPath, 'utf8');

// Map: TRIVIA
const mapTriviaPath = path.join(__dirname, 'Mapas', 'TRIVIA Wolfgang fixed by_ _R [\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D].hbs');
const mapTriviaData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapTriviaPath, 'utf8');

// Map: Game Of Thrones
const mapGOTPath = path.join(__dirname, 'Mapas', 'Game Of Thrones from HaxMaps.hbs');
const mapGOTData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGOTPath, 'utf8');

// Map: Space Case
const mapSpaceCasePath = path.join(__dirname, 'Mapas', '_Space Case by MC.hbs');
const mapSpaceCaseData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpaceCasePath, 'utf8');

// Map: American Space Carryball
const mapCarryballPath = path.join(__dirname, 'Mapas', 'American Space Carryball by Alf.hbs');
const mapCarryballData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCarryballPath, 'utf8');
...
const mapRingSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRingSurvivalPath, 'utf8');

// Map: BONK Arena by MC
const mapBonkArenaPath = path.join(__dirname, 'Mapas', 'BONK Arena by MC from HaxMaps.hbs');
const mapBonkArenaData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkArenaPath, 'utf8');
...
const mapBonkBeruData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkBeruPath, 'utf8');
...
const mapAnimalChairsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapAnimalChairsPath, 'utf8');
...
const mapBonkBeruHaxData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkBeruHaxPath, 'utf8');

// Map: Covid2 by Namajunas
const mapCovid2Path = path.join(__dirname, 'Mapas', 'Covid2byNamajunasfromHaxMaps.hbs');
const mapCovid2Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCovid2Path, 'utf8');

// Map: DOMINIC SURVIVOR 15
const mapDominicPath = path.join(__dirname, 'Mapas', 'DOMINIC SURVIVOR 15 from HaxMaps.hbs');
const mapDominicData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapDominicPath, 'utf8');

// Map: Air Hockey
const mapAirHockeyPath = path.join(__dirname, 'Mapas', 'Air Hockey v1 v2 By Lioss [\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D].hbs');
const mapAirHockeyData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapAirHockeyPath, 'utf8');

// Map: FIT IN TREN
const mapFitTrenPath = path.join(__dirname, 'Mapas', 'FIT IN TREN by NAMAJUNAS (5 red - 5 blue) from HaxMaps.hbs');
const mapFitTrenData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapFitTrenPath, 'utf8');

// Map: Fitanic
const mapFitanicPath = path.join(__dirname, 'Mapas', 'Fitanic by Şerefli Şeref [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapFitanicData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapFitanicPath, 'utf8');

// Map: Fortunate Race
const mapFortunateRacePath = path.join(__dirname, 'Mapas', 'Fortunate or unfortunate Race HD Cech from HaxMaps.hbs');
const mapFortunateRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapFortunateRacePath, 'utf8');

// Map: Kafa Topu
const mapKafaTopuPath = path.join(__dirname, 'Mapas', 'Kafa Topu by Vhagar.hbs');
const mapKafaTopuData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapKafaTopuPath, 'utf8');

// Map: Kafa Topu Shadow
const mapKafaShadowPath = path.join(__dirname, 'Mapas', 'Kafa Topu Shadow by Tudor [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapKafaShadowData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapKafaShadowPath, 'utf8');

// Map: Kuru Kafa Bonk
const mapKuruKafaPath = path.join(__dirname, 'Mapas', 'Kuru Kafa Bonk by Namajunas from HaxMaps.hbs');
const mapKuruKafaData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapKuruKafaPath, 'utf8');

// Map: Laser Race 20000
const mapLaserRacePath = path.join(__dirname, 'Mapas', 'Laser Race 20000 from HaxMaps.hbs');
const mapLaserRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLaserRacePath, 'utf8');

// Map: Capture the Vlag
const mapCTFPath = path.join(__dirname, 'Mapas', 'capture the vlag by valn [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapCTFData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCTFPath, 'utf8');
...
const mapCopsRobbersData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapCopsRobbersPath, 'utf8');

// Map: 1234
const map1234Path = path.join(__dirname, 'Mapas', '1234-by-Qua-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_6359999414324.hbs');
const map1234Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(map1234Path, 'utf8');

// Map: War of Conquest
const mapWarConquestPath = path.join(__dirname, 'Mapas', 'War-Of-Conquest-by-Namajunas-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_6556da2c05a07.hbs');
const mapWarConquestData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapWarConquestPath, 'utf8');

// Map: Tank War
const mapTankWarPath = path.join(__dirname, 'Mapas', 'Tank-War-flag-version-by-namajunas-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_63445a4ca17fe.hbs');
const mapTankWarData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapTankWarPath, 'utf8');

// Map: Jump by Qua
const mapJumpQuaPath = path.join(__dirname, 'Mapas', 'Jump by Qua [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapJumpQuaData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapJumpQuaPath, 'utf8');

// Map: Boomerang League
const mapBoomerangPath = path.join(__dirname, 'Mapas', '부메랑 리그 - 원반 v1.0.hbs');
const mapBoomerangData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBoomerangPath, 'utf8');

// Map: XD (sin gravedad)
const mapXDPath = path.join(__dirname, 'Mapas', 'xd from HaxMaps.hbs');
const mapXDData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapXDPath, 'utf8');

// Map: WWECross
const mapWWECrossPath = path.join(__dirname, 'Mapas', 'WWECross-Prototype.hbs');
const mapWWECrossData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapWWECrossPath, 'utf8');

// Map: Web Survival III
const mapWebSurvival3Path = path.join(__dirname, 'Mapas', 'Web Survival Ⅲ  by Namajunas [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapWebSurvival3Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapWebSurvival3Path, 'utf8');

// Map: Trampolin
const mapTrampolinPath = path.join(__dirname, 'Mapas', 'Trambolin.hbs');
const mapTrampolinData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapTrampolinPath, 'utf8');

// Map: Swing Trampolin
const mapSwingTrampolinPath = path.join(__dirname, 'Mapas', 'Swing Trambolin by Namajunas from HaxMaps.hbs');
const mapSwingTrampolinData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSwingTrampolinPath, 'utf8');

// Map: Super Gravedad x4
const mapSuperGravedadPath = path.join(__dirname, 'Mapas', 'Super gravedad x4 - !!zDk.hbs');
const mapSuperGravedadData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSuperGravedadPath, 'utf8');
...
const mapEndureSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapEndureSurvivalPath, 'utf8');

// Map: Endure Survival Bombs
const mapEndureBombsPath = path.join(__dirname, 'Mapas', 'Endure Survival (Bombs) by Alf [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapEndureBombsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapEndureBombsPath, 'utf8');

// Map: Bonk Movable
const mapBonkMovablePath = path.join(__dirname, 'Mapas', 'Bonk-Movable-by-Namajunas-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_618002e5bafc7.hbs');
const mapBonkMovableData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkMovablePath, 'utf8');

// Map: Lucky Race
const mapLuckyRacePath = path.join(__dirname, 'Mapas', 'Lucky race 10000 from HaxMaps.hbs');
const mapLuckyRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLuckyRacePath, 'utf8');

// Map: Street Race
const mapStreetRacePath = path.join(__dirname, 'Mapas', 'Street_race_70000 from HaxMaps.hbs');
const mapStreetRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapStreetRacePath, 'utf8');

// Map: Shooting Survival
const mapShootingSurvivalPath = path.join(__dirname, 'Mapas', 'Shooting Survival .hbs');
const mapShootingSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapShootingSurvivalPath, 'utf8');

// Map: SpaceBounce Race
const mapSpacebounceRacePath = path.join(__dirname, 'Mapas', 'SpaceBounce race 10000 from HaxMaps.hbs');
const mapSpacebounceRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpacebounceRacePath, 'utf8');

// Map: RUN Rebound
const mapRunReboundPath = path.join(__dirname, 'Mapas', 'RUN rebound 1 by pagus.hbs');
const mapRunReboundData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRunReboundPath, 'utf8');

// Map: Meadowlands Survival
const mapMeadowlandsPath = path.join(__dirname, 'Mapas', 'Meadowlands Survival.hbs');
const mapMeadowlandsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapMeadowlandsPath, 'utf8');

// Map: Ban Vote (Juicio Público)
const mapBanVotePath = path.join(__dirname, 'Mapas', 'Ban_ by Meeelany [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapBanVoteData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBanVotePath, 'utf8');

// Map: Survivor VOL 17
const mapSurvivorVol17Path = path.join(__dirname, 'Mapas', 'Survivor-VOL-17-Namajunas-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_65bee97e78587.hbs');
const mapSurvivorVol17Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSurvivorVol17Path, 'utf8');

// Map: Wind
const mapWindPath = path.join(__dirname, 'Mapas', 'Wind-by-Namajunas-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_6260f81615856.hbs');
const mapWindData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapWindPath, 'utf8');

// Map: Musical FIT
const mapMusicalFitPath = path.join(__dirname, 'Mapas', 'Musical-FIT-by-kara-aytac-14-players-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_626361ab4d651.hbs');
const mapMusicalFitData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapMusicalFitPath, 'utf8');

// Map: Namajunas Race
const mapNamajunasRacePath = path.join(__dirname, 'Mapas', 'Namajunas Race (My Last Map) from HaxMaps.hbs');
const mapNamajunasRaceData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapNamajunasRacePath, 'utf8');

// Map: Namajunas Race 2
const mapNamajunasRace2Path = path.join(__dirname, 'Mapas', 'Namajunas Race 2 [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapNamajunasRace2Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapNamajunasRace2Path, 'utf8');

// Map: Impostor (chair.hbs)
const mapImpostorPath = path.join(__dirname, 'Mapas', 'chair.hbs');
const mapImpostorData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapImpostorPath, 'utf8');

// Map: FCT 1
const mapFCT1Path = path.join(__dirname, 'Mapas', 'FCT 1 - Falafels Collision Team 1.hbs');
const mapFCT1Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapFCT1Path, 'utf8');

// Map: Fit in Graveyard
const mapGraveyardPath = path.join(__dirname, 'Mapas', 'Fit in (Graveyard) by Galactic Boy [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapGraveyardData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGraveyardPath, 'utf8');

// Map: Futbol Callejero
const mapFutbolCallejeroPath = path.join(__dirname, 'Mapas', 'Futbol callejero a las piñas.hbs');
const mapFutbolCallejeroData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapFutbolCallejeroPath, 'utf8');

// Map: Gol a Gol
const mapGolAGolPath = path.join(__dirname, 'Mapas', 'Gol a Gol by SalgadoDoce goal from HaxMaps.hbs');
const mapGolAGolData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGolAGolPath, 'utf8');

// Map: Gym 5.3 Colors
const mapGymColorsPath = path.join(__dirname, 'Mapas', 'Gym 5.3 Colors by Şerefli Şeref [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapGymColorsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGymColorsPath, 'utf8');

// Map: Gym 9
const mapGym9Path = path.join(__dirname, 'Mapas', 'Gym 9 from HaxMaps.hbs');
const mapGym9Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapGym9Path, 'utf8');

// Map: Matrix Fit
const mapMatrixFitPath = path.join(__dirname, 'Mapas', 'Matrix Fit by Vhagar [ʜᴀxᴍᴏᴅs.ᴄᴏᴍ].hbs');
const mapMatrixFitData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapMatrixFitPath, 'utf8');

// Map: Race 02
const mapRace02Path = path.join(__dirname, 'Mapas', 'Race 02 by MC from HaxMaps.hbs');
const mapRace02Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRace02Path, 'utf8');

// Map: Plum
const mapPlumPath = path.join(__dirname, 'Mapas', 'Plum from HaxMaps.hbs');
const mapPlumData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapPlumPath, 'utf8');

// Map: RUN Rebound 2
const mapRunRebound2Path = path.join(__dirname, 'Mapas', 'RUN rebound 2 by pagus.hbs');
const mapRunRebound2Data = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRunRebound2Path, 'utf8');
...
const mapSwingCannonsData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSwingCannonsPath, 'utf8');

// Map: Survival Insect
const mapSurvivalInsectPath = path.join(__dirname, 'Mapas', 'Survival-From-Insect-by-FY-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_64c62a1d6140d.hbs');
const mapSurvivalInsectData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSurvivalInsectPath, 'utf8');

// Map: Run Luck
const mapRunLuckPath = path.join(__dirname, 'Mapas', 'Run-Luck-By-Beru-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_6512efefb172b (1).hbs');
const mapRunLuckData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRunLuckPath, 'utf8');
...
const mapPinballRouletteData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapPinballRoulettePath, 'utf8');
...
const mapJumpingSurvivalData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapJumpingSurvivalPath, 'utf8');

// Map: Shaolin Soccer
const mapShaolinSoccerPath = path.join(__dirname, 'Mapas', 'Shaolin Soccer [gargus] V2 Edit [\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D].hbs');
const mapShaolinSoccerData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapShaolinSoccerPath, 'utf8');

// Map: Space Vortex
const mapSpaceVortexPath = path.join(__dirname, 'Mapas', 'Space Vortex _Asdman.hbs');
const mapSpaceVortexData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpaceVortexPath, 'utf8');

// Map: SpaceBounce Power
const mapSpaceBouncePowerPath = path.join(__dirname, 'Mapas', 'SpaceBounce Power from HaxMaps.hbs');
const mapSpaceBouncePowerData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapSpaceBouncePowerPath, 'utf8');

// Map: B.T.L
const mapBtlPath = path.join(__dirname, 'Mapas', 'B.T.L-by-Serefli-Seref-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_61ae180ad2466.hbs');
const mapBtlData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBtlPath, 'utf8');

// Map: Charge
const mapChargePath = path.join(__dirname, 'Mapas', 'Charge-2-by-Qua-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_630e6e67a8ef1.hbs');
const mapChargeData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapChargePath, 'utf8');

// Map: RUN-Mini-Pekka
const mapRunMiniPath = path.join(__dirname, 'Mapas', 'RUN-Mini-Pekka-By-zer0ne-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0C_628048143a738.hbs');
const mapRunMiniData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRunMiniPath, 'utf8');

// Map: Bonk Summer
const mapBonkSummerPath = path.join(__dirname, 'Mapas', 'Bonk-Summer-by-Serefli-Seref-20-players-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_61ae18e96d540.hbs');
const mapBonkSummerData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkSummerPath, 'utf8');

// Map: Basketball
const mapBasketballPath = path.join(__dirname, 'Mapas', '\u0299\u1D00s\u1D0B\u1D07\u1D1B\u0299\u1D00\u029F\u029F \uD83C\uDFC0 By GLH.hbs');
const mapBasketballData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBasketballPath, 'utf8');

// Map: Bonk Winter
const mapBonkWinterPath = path.join(__dirname, 'Mapas', 'Bonk-Winter-by-Serefli-Seref-20-players-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0D_61ae19074320f.hbs');
const mapBonkWinterData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapBonkWinterPath, 'utf8');

// Cargar mapas de luckys
const mapLuckPath = path.join(__dirname, 'Lucks', 'Lucky-Map-2-by-Meeelany-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_667a7e7e87381.hbs');
const mapLuckData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLuckPath, 'utf8');

const mapLuckDiosPath = path.join(__dirname, 'Lucks', 'Luck DIOS 2 by Pagus.hbs');
const mapLuckDiosData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLuckDiosPath, 'utf8');

const mapLuckHellPath = path.join(__dirname, 'Lucks', 'Lucky Hell Map 1 by Meeelany from HaxMaps.hbs');
const mapLuckHellData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapLuckHellPath, 'utf8');

// Cargar módulos de luckys desde nueva carpeta
const luckyModulePath = path.join(__dirname, 'games', 'luckys', 'lucky.js');
const luckyModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(luckyModulePath, 'utf8');

const luckyHellModulePath = path.join(__dirname, 'games', 'luckys', 'luckyhell.js');
const luckyHellModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(luckyHellModulePath, 'utf8');

const luckyDiosModulePath = path.join(__dirname, 'games', 'luckys', 'luckydios.js');
const luckyDiosModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(luckyDiosModulePath, 'utf8');

// Cargar módulos de minijuegos desde nueva carpeta
const lalalaModulePath = path.join(__dirname, 'games', 'minijuegos', 'lalala.js');
const lalalaModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(lalalaModulePath, 'utf8');

const survivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'survival.js');
const survivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(survivalModulePath, 'utf8');

const meteorsModulePath = path.join(__dirname, 'games', 'minijuegos', 'meteors.js');
const meteorsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(meteorsModulePath, 'utf8');

const jumpingModulePath = path.join(__dirname, 'games', 'minijuegos', 'jumping.js');
const jumpingModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(jumpingModulePath, 'utf8');

const websurvivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'websurvival.js');
const websurvivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(websurvivalModulePath, 'utf8');

const galacticModulePath = path.join(__dirname, 'games', 'minijuegos', 'galactic.js');
const galacticModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(galacticModulePath, 'utf8');

const gymModulePath = path.join(__dirname, 'games', 'minijuegos', 'gym.js');
const gymModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(gymModulePath, 'utf8');

const multiballsModulePath = path.join(__dirname, 'games', 'minijuegos', 'multiballs.js');
const multiballsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(multiballsModulePath, 'utf8');
const supermanModulePath = path.join(__dirname, 'games', 'minijuegos', 'superman.js');
const supermanModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(supermanModulePath, 'utf8');
const dodgeballModulePath = path.join(__dirname, 'games', 'minijuegos', 'dodgeball.js');
const dodgeballModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(dodgeballModulePath, 'utf8');
const dodgeballV2ModulePath = path.join(__dirname, 'games', 'minijuegos', 'dodgeball_v2.js');
const dodgeballV2ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(dodgeballV2ModulePath, 'utf8');
const numberChairsModulePath = path.join(__dirname, 'games', 'minijuegos', 'numberchairs.js');
const numberChairsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(numberChairsModulePath, 'utf8');
const ultraballModulePath = path.join(__dirname, 'games', 'minijuegos', 'ultraball.js');
const ultraballModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(ultraballModulePath, 'utf8');
const survSquareModulePath = path.join(__dirname, 'games', 'minijuegos', 'survivalsquare.js');
const survSquareModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(survSquareModulePath, 'utf8');
const collisionModulePath = path.join(__dirname, 'games', 'minijuegos', 'collision_team_racing.js');
const collisionModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(collisionModulePath, 'utf8');
const spotBonkModulePath = path.join(__dirname, 'games', 'minijuegos', 'spot_bonk.js');
const spotBonkModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spotBonkModulePath, 'utf8');
const spaceMeleeModulePath = path.join(__dirname, 'games', 'minijuegos', 'space_melee.js');
const spaceMeleeModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spaceMeleeModulePath, 'utf8');
const chairmixModulePath = path.join(__dirname, 'games', 'minijuegos', 'chairmix.js');
const chairmixModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(chairmixModulePath, 'utf8');
const covidModulePath = path.join(__dirname, 'games', 'minijuegos', 'covid19.js');
const covidModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(covidModulePath, 'utf8');
const gymmixModulePath = path.join(__dirname, 'games', 'minijuegos', 'gymmix.js');
const gymmixModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(gymmixModulePath, 'utf8');
const triviaModulePath = path.join(__dirname, 'games', 'minijuegos', 'trivia.js');
const triviaModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(triviaModulePath, 'utf8');
const gotModulePath = path.join(__dirname, 'games', 'minijuegos', 'got.js');
const gotModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(gotModulePath, 'utf8');
const spaceCaseModulePath = path.join(__dirname, 'games', 'minijuegos', 'space_case.js');
const spaceCaseModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spaceCaseModulePath, 'utf8');

const carryballModulePath = path.join(__dirname, 'games', 'minijuegos', 'american_carryball.js');
const carryballModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(carryballModulePath, 'utf8');

const ringSurvivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'ring_survival.js');
const ringSurvivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(ringSurvivalModulePath, 'utf8');

const bonkArenaModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_arena.js');
const bonkArenaModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkArenaModulePath, 'utf8');

const bonkBeruModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_beru.js');
const bonkBeruModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkBeruModulePath, 'utf8');

const animalChairsModulePath = path.join(__dirname, 'games', 'minijuegos', 'animalchairs_whale.js');
const animalChairsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(animalChairsModulePath, 'utf8');

const bonkBeruHaxModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_beru_hax.js');
const bonkBeruHaxModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkBeruHaxModulePath, 'utf8');

const covid2ModulePath = path.join(__dirname, 'games', 'minijuegos', 'covid2.js');
const covid2ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(covid2ModulePath, 'utf8');

const dominicModulePath = path.join(__dirname, 'games', 'minijuegos', 'dominic_survivor.js');
const dominicModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(dominicModulePath, 'utf8');

const airHockeyModulePath = path.join(__dirname, 'games', 'minijuegos', 'air_hockey.js');
const airHockeyModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(airHockeyModulePath, 'utf8');

const fitTrenModulePath = path.join(__dirname, 'games', 'minijuegos', 'fit_in_tren.js');
const fitTrenModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(fitTrenModulePath, 'utf8');

const fitanicModulePath = path.join(__dirname, 'games', 'minijuegos', 'fitanic.js');
const fitanicModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(fitanicModulePath, 'utf8');

const fortunateRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'fortunate_race.js');
const fortunateRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(fortunateRaceModulePath, 'utf8');

const kafaTopuModulePath = path.join(__dirname, 'games', 'minijuegos', 'kafa_topu.js');
const kafaTopuModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(kafaTopuModulePath, 'utf8');

const kafaShadowModulePath = path.join(__dirname, 'games', 'minijuegos', 'kafa_topu_shadow.js');
const kafaShadowModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(kafaShadowModulePath, 'utf8');

const kuruKafaModulePath = path.join(__dirname, 'games', 'minijuegos', 'kuru_kafa_bonk.js');
const kuruKafaModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(kuruKafaModulePath, 'utf8');

const laserRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'laser_race.js');
const laserRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(laserRaceModulePath, 'utf8');

const ctfModulePath = path.join(__dirname, 'games', 'minijuegos', 'capture_the_flag.js');
const ctfModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(ctfModulePath, 'utf8');

const copsRobbersModulePath = path.join(__dirname, 'games', 'minijuegos', 'cops_robbers.js');
const copsRobbersModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(copsRobbersModulePath, 'utf8');

const juego1234ModulePath = path.join(__dirname, 'games', 'minijuegos', 'juego_1234.js');
const juego1234ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(juego1234ModulePath, 'utf8');

const warConquestModulePath = path.join(__dirname, 'games', 'minijuegos', 'war_conquest.js');
const warConquestModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(warConquestModulePath, 'utf8');

const tankWarModulePath = path.join(__dirname, 'games', 'minijuegos', 'tank_war.js');
const tankWarModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(tankWarModulePath, 'utf8');

const jumpQuaModulePath = path.join(__dirname, 'games', 'minijuegos', 'jump.js');
const jumpQuaModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(jumpQuaModulePath, 'utf8');

const boomerangModulePath = path.join(__dirname, 'games', 'minijuegos', 'boomerang_league.js');
const boomerangModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(boomerangModulePath, 'utf8');

const xdGoalsModulePath = path.join(__dirname, 'games', 'minijuegos', 'xd_goals.js');
const xdGoalsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(xdGoalsModulePath, 'utf8');

const wwecrossModulePath = path.join(__dirname, 'games', 'minijuegos', 'wwecross.js');
const wwecrossModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(wwecrossModulePath, 'utf8');

const webSurvival3ModulePath = path.join(__dirname, 'games', 'minijuegos', 'web_survival_3.js');
const webSurvival3ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(webSurvival3ModulePath, 'utf8');

const trampolinModulePath = path.join(__dirname, 'games', 'minijuegos', 'trampolin.js');
const trampolinModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(trampolinModulePath, 'utf8');

const swingTrampolinModulePath = path.join(__dirname, 'games', 'minijuegos', 'swing_trampolin.js');
const swingTrampolinModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(swingTrampolinModulePath, 'utf8');

const superGravedadModulePath = path.join(__dirname, 'games', 'minijuegos', 'super_gravedad.js');
const superGravedadModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(superGravedadModulePath, 'utf8');

const endureSurvivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'endure_survival.js');
const endureSurvivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(endureSurvivalModulePath, 'utf8');

const luckyRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'lucky_race.js');
const luckyRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(luckyRaceModulePath, 'utf8');

const streetRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'street_race.js');
const streetRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(streetRaceModulePath, 'utf8');

const shootingSurvivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'shooting_survival.js');
const shootingSurvivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(shootingSurvivalModulePath, 'utf8');

const spacebounceRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'spacebounce_race.js');
const spacebounceRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spacebounceRaceModulePath, 'utf8');

const runReboundModulePath = path.join(__dirname, 'games', 'minijuegos', 'run_rebound.js');
const runReboundModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(runReboundModulePath, 'utf8');

const meadowlandsModulePath = path.join(__dirname, 'games', 'minijuegos', 'meadowlands.js');
const meadowlandsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(meadowlandsModulePath, 'utf8');

const survivorVol17ModulePath = path.join(__dirname, 'games', 'minijuegos', 'survivor_vol17.js');
const survivorVol17ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(survivorVol17ModulePath, 'utf8');

const windModulePath = path.join(__dirname, 'games', 'minijuegos', 'wind.js');
const windModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(windModulePath, 'utf8');

const impostorModulePath = path.join(__dirname, 'games', 'minijuegos', 'impostor.js');
const impostorModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(impostorModulePath, 'utf8');
const pistoleroModulePath = path.join(__dirname, 'games', 'minijuegos', 'pistolero.js');
const pistoleroModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(pistoleroModulePath, 'utf8');

const bonkMovableModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_movable.js');
const bonkMovableModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkMovableModulePath, 'utf8');

const endureBombsModulePath = path.join(__dirname, 'games', 'minijuegos', 'endure_bombs.js');
const endureBombsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(endureBombsModulePath, 'utf8');

const musicalFitModulePath = path.join(__dirname, 'games', 'minijuegos', 'musical_fit.js');
const musicalFitModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(musicalFitModulePath, 'utf8');

const namajunasRaceModulePath = path.join(__dirname, 'games', 'minijuegos', 'namajunas_race.js');
const namajunasRaceModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(namajunasRaceModulePath, 'utf8');

const namajunasRace2ModulePath = path.join(__dirname, 'games', 'minijuegos', 'namajunas_race2.js');
const namajunasRace2ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(namajunasRace2ModulePath, 'utf8');

const fct1ModulePath = path.join(__dirname, 'games', 'minijuegos', 'fct1.js');
const fct1ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(fct1ModulePath, 'utf8');

const graveyardModulePath = path.join(__dirname, 'games', 'minijuegos', 'fit_in_graveyard.js');
const graveyardModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(graveyardModulePath, 'utf8');

const futbolCallejeroModulePath = path.join(__dirname, 'games', 'minijuegos', 'futbol_callejero.js');
const futbolCallejeroModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(futbolCallejeroModulePath, 'utf8');

const golAGolModulePath = path.join(__dirname, 'games', 'minijuegos', 'gol_a_gol.js');
const golAGolModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(golAGolModulePath, 'utf8');

const gymColorsModulePath = path.join(__dirname, 'games', 'minijuegos', 'gym_colors.js');
const gymColorsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(gymColorsModulePath, 'utf8');

const gym9ModulePath = path.join(__dirname, 'games', 'minijuegos', 'gym9.js');
const gym9ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(gym9ModulePath, 'utf8');

const matrixFitModulePath = path.join(__dirname, 'games', 'minijuegos', 'matrix_fit.js');
const matrixFitModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(matrixFitModulePath, 'utf8');

const race02ModulePath = path.join(__dirname, 'games', 'minijuegos', 'race02.js');
const race02ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(race02ModulePath, 'utf8');

const plumModulePath = path.join(__dirname, 'games', 'minijuegos', 'plum.js');
const plumModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(plumModulePath, 'utf8');

const runRebound2ModulePath = path.join(__dirname, 'games', 'minijuegos', 'run_rebound_2.js');
const runRebound2ModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(runRebound2ModulePath, 'utf8');

const swingCannonsModulePath = path.join(__dirname, 'games', 'minijuegos', 'swing_cannons.js');
const swingCannonsModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(swingCannonsModulePath, 'utf8');

const survivalInsectModulePath = path.join(__dirname, 'games', 'minijuegos', 'survival_insect.js');
const survivalInsectModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(survivalInsectModulePath, 'utf8');

const runLuckModulePath = path.join(__dirname, 'games', 'minijuegos', 'run_luck.js');
const runLuckModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(runLuckModulePath, 'utf8');

const pinballRouletteModulePath = path.join(__dirname, 'games', 'minijuegos', 'pinball_roulette.js');
const pinballRouletteModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(pinballRouletteModulePath, 'utf8');

const jumpingSurvivalModulePath = path.join(__dirname, 'games', 'minijuegos', 'jumping_survival.js');
const jumpingSurvivalModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(jumpingSurvivalModulePath, 'utf8');

const shaolinSoccerModulePath = path.join(__dirname, 'games', 'minijuegos', 'shaolin_soccer.js');
const shaolinSoccerModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(shaolinSoccerModulePath, 'utf8');

const spaceVortexModulePath = path.join(__dirname, 'games', 'minijuegos', 'space_vortex.js');
const spaceVortexModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spaceVortexModulePath, 'utf8');

const spaceBouncePowerModulePath = path.join(__dirname, 'games', 'minijuegos', 'spacebounce_power.js');
const spaceBouncePowerModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(spaceBouncePowerModulePath, 'utf8');

const basketballModulePath = path.join(__dirname, 'games', 'minijuegos', 'basketball.js');
const basketballModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(basketballModulePath, 'utf8');

const btlModulePath = path.join(__dirname, 'games', 'minijuegos', 'btl.js');
const btlModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(btlModulePath, 'utf8');

const bonkSummerModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_summer.js');
const bonkSummerModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkSummerModulePath, 'utf8');

const bonkWinterModulePath = path.join(__dirname, 'games', 'minijuegos', 'bonk_winter.js');
const bonkWinterModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(bonkWinterModulePath, 'utf8');

const zombieRunModulePath = path.join(__dirname, 'games', 'minijuegos', 'zombie_run.js');
const zombieRunModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(zombieRunModulePath, 'utf8');

const racingGroundModulePath = path.join(__dirname, 'games', 'minijuegos', 'racing_ground.js');
const racingGroundModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(racingGroundModulePath, 'utf8');

const buhoModulePath = path.join(__dirname, 'games', 'minijuegos', 'buho.js');
const buhoModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(buhoModulePath, 'utf8');

const chargeModulePath = path.join(__dirname, 'games', 'minijuegos', 'charge.js');
const chargeModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(chargeModulePath, 'utf8');
const runMiniModulePath = path.join(__dirname, 'Mapas', 'RUN-Mini-Pekka-By-zer0ne-\u029C\u1D00x\u1D0D\u1D0F\u1D05s.\u1D04\u1D0F\u1D0C_628048143a738.hbs');
const runMiniModuleCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(runMiniModulePath, 'utf8');
...
if (fs.existsSync(buhoMapsDir)) {
    fs.readdirSync(buhoMapsDir).forEach(function(file) {
        ...
        if (match) {
            const key = match[1];
            const content = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(path.join(buhoMapsDir, file), 'utf8');
...
const mapZombieRunData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapZombieRunPath, 'utf8');

// Map: Racing Ground
const mapRacingGroundPath = path.join(__dirname, 'Mapas', '1.-Racing-Ground-ʜᴀxᴍᴏᴅs.ᴄᴏᴍ_66d7c2a6a6359.hbs');
const mapRacingGroundData = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(mapRacingGroundPath, 'utf8');

// Cargar código principal de la sala
const roomMainCodePath = path.join(__dirname, 'room-main.txt');
const roomMainCode = (function(){try{return fs.readFileSync.apply(fs,arguments)}catch(e){return JSON.stringify({})}})(roomMainCodePath, 'utf8');
