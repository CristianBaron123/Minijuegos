...
function start(room, onGameEnd) {
    if (!mapData) { console.error('[TANK_WAR] mapData no inyectado.'); if (onGameEnd) onGameEnd(null); return; }
    ...
    if (gameState.firstRound) {
        ...
        setTimeout(function() {
            ...
            room.sendAnnouncement(
                '\n📋 INSTRUCCIONES:\n' +
                '🔵 Defiende el balón bajo tu portería — si el rival lo golpea cuentas como gol!\n' +
