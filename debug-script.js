...
function checkAndStart() {
    ...
    if (playerCount < 2) {
        ...
        var minigames = [
            ...
            { name: 'METEORS', module: METEORS, displayName: 'METEORS SURVIVAL', starter: startMETEORS },
            ...
            { name: 'SUPERMAN', module: SUPERMAN, displayName: 'SUPERMAN', starter: startSUPERMAN },
